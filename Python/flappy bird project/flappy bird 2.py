...
game_image = {}
game_audio_sound = {}
player = 'images/spritesfb/bird.png'
bcg_image = 'images/spritesfb/background.png'
pipe_image = 'images/spritesfb/pipe.png'
...
if __name__ == "__main__":
    ...
    game_image['numbers'] = (
        pygame.image.load('images/spritesfb/0.png').convert_alpha(),
        pygame.image.load('images/spritesfb/1.png').convert_alpha(),
        pygame.image.load('images/spritesfb/2.png').convert_alpha(),
        pygame.image.load('images/spritesfb/3.png').convert_alpha(),
        pygame.image.load('images/spritesfb/4.png').convert_alpha(),
        pygame.image.load('images/spritesfb/5.png').convert_alpha(),
        pygame.image.load('images/spritesfb/6.png').convert_alpha(),
        pygame.image.load('images/spritesfb/7.png').convert_alpha(),
        pygame.image.load('images/spritesfb/8.png').convert_alpha(),
        pygame.image.load('images/spritesfb/9.png').convert_alpha(),
        )
